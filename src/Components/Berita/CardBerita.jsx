    ...
    return(
        <div className="w-[25%] m-5 min-w-[300px] overflow-hidden rounded-lg">
            <div className="relative rounded-lg">
                ...
                <div onMouseEnter={() => setIsHover(true)} onMouseOut={() => setIsHover(false)} className="bg absolute w-full h-[100px] bottom-0" style={{background: 'linear-gradient(0deg, #000000 -7.73%, rgba(0, 0, 0, 0) 50%)'}}></div>
            </div>
