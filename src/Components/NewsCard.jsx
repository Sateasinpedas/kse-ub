...
export default function NewsCard({name, imageUrl, newsLink}){
    ...
    return(
        <a href='/about' className="mx-auto md:mx-0 w-[80%] md:w-2/5 rounded-xl shadow-xl bg-white md:h-[250px] h-[180px] relative bg-cover bg-no-repeat overflow-hidden" style={{background: 'linear-gradient(0deg, #000000 -7.73%, rgba(0, 0, 0, 0) 50%), no-repeat', backgroundSize: "cover"}}>
