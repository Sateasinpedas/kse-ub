...
export default function Add() {
    ...
    const [title, setTitle] = React.useState(JSON.parse(localStorage.getItem('news')).title);
    const [link, setLink] = React.useState(JSON.parse(localStorage.getItem('news')).link);
    const [richContent, setRichContent] = React.useState(JSON.parse(localStorage.getItem('news')).description);
                ...
                <div className="w-full flex justify-start flex-wrap">
                    <form onSubmit={handleSubmit} className="w-full bg-white rounded-lg p-5 mb-5">
                        <div className="mb-5">
                            ...
                            <InputAdmin defaultValue={news.title} onChange={(e) => setTitle(e.target.value)} type='text' required className='w-full' placeholder='title' beginningIcon={<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                        ...
                        <div className="mb-5">
                            ...
                            <InputAdmin defaultValue={news.link} onChange={(e) => setLink(e.target.value)} type='text' required className='w-full' placeholder='link' beginningIcon={<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
