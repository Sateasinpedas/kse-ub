...
export default function Edit() {
    ...
    const [title, setTitle] = React.useState(JSON.parse(localStorage.getItem('faq')).title);
    const [answer, setAnswer] = React.useState(JSON.parse(localStorage.getItem('faq')).answer);
                ...
                <div className="w-full flex justify-start flex-wrap">
                    <form className="w-full bg-white rounded-lg p-5 mb-5" onSubmit={handleSubmit}>
                        <div className="mb-5">
                            ...
                            <InputAdmin defaultValue={faq.title} onChange={(e) => setTitle(e.target.value)} type='text' required className='w-full' placeholder='title' beginningIcon={<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                        ...
                        <div className="mb-5">
                            ...
                            <InputAdmin defaultValue={faq.answer} onChange={(e) => setAnswer(e.target.value)} type='text' required className='w-full' placeholder='description' beginningIcon={<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                                <path strokeLinecap="round" strokeLinejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L6.832 19.82a4.5 4.5 0 01-1.897 1.13l-2.685.8.8-2.685a4.5 4.5 0 011.13-1.897L16.863 4.487zm0 0L19.5 7.125" />
                            </svg>
                            } />
                        </div>
