...
export default function Add() {
    ...
    const createMitra = async () => {
        setIsLoading(true);
        await addDoc(collection(db, "mitras"), {
            title,
            link,
                ...
                <div className="w-full flex justify-start flex-wrap">
                    <form onSubmit={handleSubmit} className="w-full bg-white rounded-lg p-5 mb-5">
                        <div className="mb-5">
                            ...
                            <InputAdmin onChange={(e) => setTitle(e.target.value)} type='text' required className='w-full' placeholder='name' beginningIcon={<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
