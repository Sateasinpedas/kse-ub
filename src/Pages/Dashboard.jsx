        ...
        <div>
            ...
            <div className="jumbotron bg-purple md:px-[100px] px-[50px] font-sans text-white p-32 md:pt-40 relative overflow-hidden min-h-screen">
                <div className="mt-[85px]">
                    <h1 className="text-5xl font-bold relative z-20">Karya Salemba Empat</h1>
                    <h2 className="text-3xl md:font-bold mt-3 relative z-20">Universitas Brawijaya</h2>
                    <h2 className="text-3xl md:font-bold mb-5 relative z-20">2022 - 2023</h2>
            ...
            <div className="news-card">
                <div className="flex items-center w-[75%] justify-between mx-auto mt-20">
                    <h3 className="w-[35%] text-2xl font-bold -mt-1">Berita Terkini</h3>
                    <hr className="border-[1.6px] bg-black border-black rounded w-[100%] -ml-10 " />
                    <Link to='/berita' className="w-[30%]">
                        <button className="bg-black rounded-lg px-5 py-1 text-white text-sm flex items-center justify-center font-sans">
                            Lihat semua
                        </button>
                    </Link>
                </div>
                <div className="flex items-start mx-auto justify-center mt-10" id="berita-terkini">
                    <NewsCard />
                    <div className="bg-purple rounded-xl text-white p-10 pb-7 w-2/5 ml-5 font-semibold font-sans">
                        <div className="mb-7">
                ...
                <div className="flex w-[80%] mx-auto mt-32 items-start">
                    <div className="tentang w-[50%]">
                        <h1 className="font-bold text-3xl mb-2">Tentang</h1>
                        <p className="text-justify">Berkat dukungan semua pihak, Beasiswa KSE telah berkembang dengan memberikan dukungan kepada lebih dari 20.000 mahasiswa dari 34 Perguruan Tinggi Negeri. KSE adalah jembatan bagi berbagai perusahaan dan individu dalam menyalurkan sumbangan mereka kepada kandidat dan program-program peningkatan soft skill yang tepat. Selain itu, KSE juga mendorong dan turut mempersiapkan penerima beasiswa menjadi lulusan yang memiliki integritas, berwawasan kebangsaan, cinta pada tanah air nusa dan bangsa melalui berbagai program-program pembinaan.</p>
                    </div>
                    <div className="w-[50%] ml-20 text-justify">
                        <div>
                ...
                <div className="w-[80%] mx-auto mt-32 flex items-center">
                    <div className="tentang w-[40%]">
                        <h1 className="font-bold text-3xl mb-2">Apa Kata Para <br /> Beswan KSE</h1>
                        <p className="mt-5">Testimoni Beswan KSE UB</p>
                    </div>
                    <div className="tentang w-[60%]">
